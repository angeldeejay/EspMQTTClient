...
public:
  ...
  inline void setMqttServer(const char *server, const char *username = "", const char *password = "", const uint16_t port = 1883)
  ...
  void setWifiStaticConfig(IPAddress local_ip, IPAddress gateway, IPAddress subnet, IPAddress dns1, IPAddress dns2);
  void setWifiStaticConfig(const char *local_ip, const char *gateway, const char *subnet, const char *dns1, const char *dns2);
